...
public class BukatutakoRidesGUI extends JFrame {
	...
	private final JLabel jLabelEvents = new JLabel(ResourceBundle.getBundle(etik).getString("BukatutakoRidesGUI.Title")); 
	private JButton jButtonSelectRide = new JButton(ResourceBundle.getBundle(etik).getString("BukatutakoRidesGUI.SelectRide"));
	...
	public BukatutakoRidesGUI(Driver d)
	{
		...
		this.setTitle(ResourceBundle.getBundle(etik).getString("BukatutakoRidesGUI.Title"));
		...
		jButtonBack.setBounds(new Rectangle(10, 423, 130, 30));
		...
		jButtonSelectRide.setBounds(new Rectangle(200, 417, 130, 30));
		jButtonSelectRide.setBounds(225, 415, 245, 30);
		getContentPane().add(jButtonSelectRide);
		...
		jButtonSelectRide.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				jLabelNotSelectedError.setVisible(false);
				jLabelErreserbaDagoError.setVisible(false);
				...
				if (unekoRide != null) {
					...
					dispose();
					BalErrRideGUI dgui = new BalErrRideGUI(driver, facade.getRide(Integer.parseInt(zatiak[0])));
					dgui.setVisible(true);
				}
