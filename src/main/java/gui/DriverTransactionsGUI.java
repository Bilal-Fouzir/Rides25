...
public class DriverTransactionsGUI extends JFrame {
	...
	public DriverTransactionsGUI(Driver d)
	{
		...
		if(driver.getTransactions()!=null) {
			for (Transaction trans : driver.getTransactions()) {
