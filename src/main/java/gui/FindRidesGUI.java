...
public class FindRidesGUI extends JFrame {
	...
	private final JLabel jLabelEventDate = new JLabel(ResourceBundle.getBundle(etik).getString("CreateRideGUI.RideDate"));
	...
	public FindRidesGUI()
	{
		...
		this.setTitle(ResourceBundle.getBundle(etik).getString("LoginGUI.QueryRides"));
		...
		jButtonBack.setBounds(new Rectangle(274, 419, 130, 30));
